...
<body style="color: black; font-family: Verdana;">
    ...
    <table align="center" width="1000px" style="padding: 50px; color: black; font-family: Verdana;">
                ...
                <div style="background-color: #e6e6e6; padding: 50px; color:black;">
                    <table width="1000px">
                        ...
                        <form action="" type="GET">
                            <tr>
                                <td colspan=4>Search: &nbsp<input type="text" name="keyword"
                                        style="font-size:20px; width: 550px;" value="<?php echo $keyword ?>"></td>
                                <td style="display: flex;">Employer: &nbsp<input type="text" name="employer"
                                        style="font-size:20px; flex: 1;" value="<?php echo $employer ?>"></td>
                            </tr>
                            <tr>
                                <td>Catagory</td>
                                <td>Type</td>
        ...
        <?php
            ...
            $sql = "SELECT * FROM job WHERE 1 ". $catstring . $typestring . $salstring . $expstring . $locstring . $keystring . $empstring . "LIMIT 5 OFFSET $page";
