...
?>
    ...
    <body style="">
        ...
        <table width="100%" style="padding: 25px; background-color: #9999ff; color: white; font-family: Verdana;">
            <tr>
                <td width="250px" align="left" style="color:#ffff99; font-size:50px; font-family:Brush Script MT;"><a href="admin.php" style="text-decoration : none;">Job-Platform</a></td>
                <td width="" align="left" style="font-size:25px">Welcome <?php 
                
                if(isset($_SESSION['user'])){
                    $sql = "SELECT * FROM admin WHERE userID='$loginID';";
