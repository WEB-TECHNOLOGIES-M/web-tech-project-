    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        elseif(isset($_POST['sekreg'])){
            ...
            if(!empty($_POST['pass'])){
                ...
                if(!empty($_POST['cpass'])){
                    ...
                    if($pass==$cpass){
                        ...
                        $cperr="Passwords doesnt not match!";
                    }
                }
                else {
            ...
            if($nerr==""&&$uerr==""&&$perr==""&&$cperr==""&&$emerr==""){
                ...
                $sql2 = "INSERT INTO seekerinfo (email,name)
                VALUES ('$email','$fname');";

                mysqli_query($conn, $sql2);
                $_SESSION['sekreg']="Successful";

                $sql2 = "INSERT INTO seekerappliedjobs (email)
                VALUES ('$email');";

                mysqli_query($conn, $sql2);
                $_SESSION['sekreg']="Successful";
                
                $sql2 = "INSERT INTO seekereducation (email)
                VALUES ('$email');";

                mysqli_query($conn, $sql2);
                $_SESSION['sekreg']="Successful";

                $sql2 = "INSERT INTO seekerskill (email)
                VALUES ('$email');";

                mysqli_query($conn, $sql2);
                $_SESSION['sekreg']="Successful";

                $sql2 = "INSERT INTO seekerworkexperience (email)
                VALUES ('$email');";
